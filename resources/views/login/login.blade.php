...
<!-- Start wrapper-->
 ...
 <div class="loader-wrapper"><div class="lds-ring"><div></div><div></div><div></div><div></div></div></div>
		...
		<div class="card-body">
		 <div class="card-content p-2">
		  ...
		  <div class="card-footer text-center py-3">
		    <p class="text-warning mb-0">Do not have an account? <a href="{{route('register')}}"> Đăng ký tài khoản</a></p>
		  </div>
	     </div>
  ...
  <!-- sidebar-menu js -->
  <script src="{{'Css/assets/js/sidebar-menu.js'}}"></script>
  
  <!-- Custom scripts -->
  <script src="{{'Css/assets/js/app-script.js'}}"></script>
