    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="group">
                ...
                <div class="btn-add ">
                    <a class='btn btn-info mt-3 float-right mr-3 ' id="addHS">Thêm học
                        sinh</a>
                </div>
            ...
            <div class="modal-content" style="background-color: #17a2b8">
                ...
                <div class="modal-body text-center ">
                    ...
                    <form action="{{ route('student.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="group">
                            ...
                            <div class="form-group col-lg-6 text-left">
                                ...
                                <select name="MaLH" id="MaLH" class="form-control" required>
                                    <option value="{{ $lophoc->id }}">{{ $lophoc->khoi . $lophoc->name }}</option>
                                </select>
                                <div class="position-relative has-icon-right">
                                    @if ($errors->first('MaLH'))
                                        <p class="text-danger">
                        ...
                        <div class="group">
                            ...
                            <div class="form-group col-lg-6 text-left">
                                ...
                                <input type="file" class="form-control" name='image'
                                    accept=".jpg, .jpeg, .png, .bmp, .gif, .svg" id="image" placeholder="Enter Your Avata">
                        ...
                        <input type="hidden" name='id_lh' value="{{ $lophoc->id }}">
                        <div class="form-group py-2 float-left">
                            <div class="icheck-material-white">
                                <input type="checkbox" id="user-checkbox1" checked="" />
                                <label for="user-checkbox1">I Agree Terms &
                ...
                <div class="modal-footer" style="border-top:0">
                    ...
                    <div class="form-group col-lg-6">
                        <a href="" class="btn btn-light px-5 ml-4 " data-dismiss="modal">Quay lại</a>
                    </div>
                    <div class="form-group col-lg-6">

                        <button type="submit" class="btn btn-light px-5 float-right" id='submit'>Lưu</button>
                    </div>
