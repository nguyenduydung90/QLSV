        ...
        <div class="card">
            ...
            <div class="group">
                ...
                <div class="count-student ">
                    <label for="hoten" class="label">Sĩ số: </label>
                                ...
                                @foreach ($students as $key => $s)
                                    <tr>
                                        ...
                                        <td class="hidden-phone text-left">
                                            {{ $s->IdLop == 'null' ? 'Chưa phân lớp' : $s->khoi . $s->lop }}</td>

                                        <td class="hidden-phone">{{ $s->address }}</td>
                                        <td class="hidden-phone">{{ $s->phone }}</td>
                                        <td class="text-right">
                                            <button type="button" data-toggle="modal"
                                            data-target="#mymodal{{ $s->id }}"  class="btn btn-primary btn-sm editHS"><i
                                                                                                ...
                                                                                                <div class="modal-dialog">
                                                                                                    <div class="modal-content" style="background-color: #17a2b8">
                                                                                                        ...
                                                                                                        <div class="modal-body text-center ">
                                                                                                            ...
                                                                                                            <form id='form-edit' action="{{route('student.update',$s->id)}}"  method="post"
                                                                                                                ...
                                                                                                                <div class="group">
                                                                                                                    <div class="form-group col-lg-6 text-left">
                                                                                                                        ...
                                                                                                                        <input type="text" class="form-control" name='name'
                                                                                                                            id="name" value="{{$s->name}}"  placeholder="Enter Your Name" required>
                                                                                                                    ...
                                                                                                                    <div class="form-group col-lg-6 text-left">
                                                                                                                        ...
                                                                                                                        <input type="date" class="form-control" name='birthday'
                                                                                                                            id="birthday" value="{{$s->birthday}}" placeholder="Enter Your Birthday"
                                                                                                                            required>
                                                                                                                        <div class="position-relative has-icon-right">
                                                                                                                ...
                                                                                                                <div class="group">
                                                                                                                    <div class="form-group col-lg-6 text-left">
                                                                                                                        ...
                                                                                                                        <input type="text" class="form-control" name='phone'
                                                                                                                            id="phone" value="{{$s->phone}}" placeholder="Enter Your Mobile Number"
                                                                                                                            required>
                                                                                                                        <div class="position-relative has-icon-right">
                                                                                                                    ...
                                                                                                                    <div class="form-group col-lg-6 text-left">
                                                                                                                        ...
                                                                                                                        <select name="MaLH" id="MaLH" class="form-control"
                                                                                                                            required>
                                                                                                                            @foreach ($lophocs as $key => $l )
                                                                                                                            <option value="{{$l->id}}" {{$s->MaLH==$l->id?"selected='seclected'":''}}>{{$l->khoi}}{{$l->name}}</option>
                                                                                                                          @endforeach
                                                                                                                        </select>
                                                                                                                        <div class="position-relative has-icon-right">
                                                                                                                ...
                                                                                                                <div class="group">
                                                                                                                    <div class="form-group col-lg-6 text-left ">
                                                                                                                        ...
                                                                                                                        <select name="gender" id="gender" class="form-control"
                                                                                                                            ...
                                                                                                                            <option value="Nam" {{$s->gender=='Nam'?"selected='seclected'":''}}>Nam</option>
                                                                                                                            <option value="Nữ"{{$s->gender=='Nữ'?"selected='seclected'":''}}>Nữ</option>
                                                                                                                        </select>
                                                                                                                        <div class="position-relative has-icon-right">
